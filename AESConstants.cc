...
const unsigned char AESConstants::SBOX[256] = { 	0x63, 	0x7C, 	0x77, 	0x7B, 	0xF2, 	0x6B, 	0x6F, 	0xC5, 	0x30, 	0x01,
...
const unsigned char AESConstants::INV_SBOX[256] = { 	0x52, 	0x09, 	0x6A, 	0xD5, 	0x30, 	0x36, 	0xA5, 	0x38, 	0xBF, 	0x40,
...
const unsigned char AESConstants::MIXER[4][4] = 	{	{0x02, 0x03, 0x01, 0x01},
										{0x01, 0x02, 0x03, 0x01},
										{0x01, 0x01, 0x02, 0x03},
										{0x03, 0x01, 0x01, 0x02}	};

const unsigned char AESConstants::INV_MIXER[4][4] = 	{	{0x09, 0x0e, 0x0b, 0x0d},
											{0x0d, 0x09, 0x0e, 0x0b},
											{0x0b, 0x0d, 0x09, 0x0e},
											{0x0e, 0x0b, 0x0d, 0x09}	};
